...
class _MyDepartmentalGraduatesDetailsPageDState extends State<MyDepartmentalGraduatesDetailsPageD> {
  ...
  initState(){
    ...
    _snapchat = departmentalGraduatesDNotifier.currentDepartmentalGraduatesD.snapchat;
    _tikTok = departmentalGraduatesDNotifier.currentDepartmentalGraduatesD.tikTok;
    _favSchoolActivity = departmentalGraduatesDNotifier.currentDepartmentalGraduatesD.favSchoolActivity;
    _scpcExecutive = departmentalGraduatesDNotifier.currentDepartmentalGraduatesD.scpcExecutive;
    _scpcExecutivePosition = departmentalGraduatesDNotifier.currentDepartmentalGraduatesD.scpcExecutivePosition;
    ...
    _originState = departmentalGraduatesDNotifier.currentDepartmentalGraduatesD.stateOfOrigin;
    _whatsNext = departmentalGraduatesDNotifier.currentDepartmentalGraduatesD.whatsNext;
    _stateResiding = departmentalGraduatesDNotifier.currentDepartmentalGraduatesD.whereYouReside;
    _bestMoment = departmentalGraduatesDNotifier.currentDepartmentalGraduatesD.bestMoment;
